...
abstract class $InfoAboutCityCopyWith<$Res> {
  ...
  $Res call({int id, String name, String country, int sunrise, int sunset});
}
...
class _$_InfoAboutCity implements _InfoAboutCity {
  ...
  @override
  String toString() {
    return 'InfoAboutCity(id: $id, name: $name, country: $country, sunrise: $sunrise, sunset: $sunset)';
  }
...
abstract class _InfoAboutCity implements InfoAboutCity {
  factory _InfoAboutCity(
      ...
      required final int sunset}) = _$_InfoAboutCity;
